...
interface TreeSuccessModalProps {
  visible: boolean;
  treeName: string;
  mode: "add" | "edit";
}

export function TreeSuccessModal({ visible, treeName, mode }: TreeSuccessModalProps) {
      ...
      <View style={styles.backdrop}>
        ...
        >
          ...
          <Text style={styles.title}>
            {mode === "add" ? "Tree Added!" : "Tree Updated!"}
          </Text>
          <Text style={styles.message}>
            <Text style={styles.treeName}>{treeName}</Text>{" "}
            {mode === "add"
              ? "has been successfully added to the tree master."
